pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'MANYFOLD_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-manyfold'
    DOCKERHUB_IMAGE = 'linuxserver/manyfold'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/manyfold'
    PR_DOCKERHUB_IMAGE = 'lspipepr/manyfold'
    DIST_IMAGE = 'alpine'
    MULTIARCH='true'
    CI='true'
    CI_WEB='false'
    ...
    CI_SSL='false'
    CI_DELAY='120'
    CI_DOCKERENV='SECRET_KEY_BASE=placeholder|DATABASE_URL=sqlite3:/config/manyfold.sqlite3|DOCKER_MODS=linuxserver/mods:universal-package-install|INSTALL_PACKAGES=redis'
    CI_AUTH=''
    CI_WEBPATH=''
  }
  stages {
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-manyfold/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-manyfold\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-manyfold\" \
